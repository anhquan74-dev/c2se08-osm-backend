...
Route::middleware(['or-middleware:customer|provider|admin'])->group(function () {
    ...
    Route::get('/packages-by-provider/{provider_id}', [PackageController::class, 'getAllPackagesByProviderId']);
    ...
    Route::get('/appointments-customer', [AppointmentController::class, 'getAllAppointmentsByStatusForCustomer']);
    Route::get('/appointments-provider', [AppointmentController::class, 'getAllAppointmentsByStatusForProvider']);
    ...
    Route::get('/appointments-count/{user_id}', [AppointmentController::class, 'getTotalAppointmentsByUser']);
