...
//             socket
//                 .in(user.groupBlood)
//                 .emit("request_received", newRequestReceived);
//         });
//         socket.room = user.groupBlood;
//         socket.on("donor_confirm_request", (requestConfirmed) => {
//             socket
//                 .in(user.groupBlood)
//                 .emit("recieved_donor_confirm", requestConfirmed);
//         });
//         socket.on(
//             "recipient_confirm_request",
//             (requestConfirmedByRecipient) => {
//                 socket
//                     .in(user.groupBlood)
//                     .emit(
//                         "recieved_recipient_confirm",
//                         requestConfirmedByRecipient
//                     );
//             }
//         );
...
//             socket
//                 .in(user.groupBlood)
//                 .emit("recieved_recipient_delete", requestDeleted);
//         });
//         socket.on("recipient_update_request", (requestUpdated) => {
//             socket
//                 .in(user.groupBlood)
//                 .emit("recieved_recipient_update", requestUpdated);
//         });
...
//             if (receiver) {
//                 io.to(receiver.socketId).emit(
//                     "get_recipient_confirm_notify_success",
//                     data
//                 );
//             } else {
//                 console.log("user offfline");
...
//             if (receiver) {
//                 io.to(receiver.socketId).emit(
//                     "get_recipient_confirm_notify_failed",
//                     data
//                 );
//             } else {
//                 console.log("user offfline");
